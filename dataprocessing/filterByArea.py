...
minCoord = (42, -71.02)
maxCoord = (43, -71)
pickups  = parseFiltered("../../filtered_pickups_9_12.csv")
dropoffs = parseFiltered("../../filtered_dropoffs_9_12.csv")
...
#  print id
print "Number: " + str(len(filtered)) #number of accepted trips
